...
Run the numbered paired-end Plasmodium WGS MOI/Fws pipeline sequentially.
...
echo "Config: $CONFIG"
echo "The numbered steps run sequentially; completed files are reused when RESUME=1."
